...
<head>
    ...
    <!--//-------Seo--------->
<style>
    h2.title {color: #FE980F;font-family: 'Roboto', sans-serif;font-size: 18px;font-weight: 700;margin:10px 10px;text-transform: uppercase;margin-bottom: 30px;position: relative;}
.breadcrumbs .breadcrumb li a:after {content: "";height: auto;width: auto;border-width: 8px;border-style: solid;border-color: transparent transparent transparent #FE980F;position: absolute;top: 11px;left: 80px;}
</style>
</head><!--/head-->
...
<body>
    ...
    <header id="header"><!--header-->
                ...
                <div class="row">
                    <div  class="col-sm-4" style="padding: 0">
                        <div class="logo pull-left">
                            <a href="{{URL::to('/trang-chu')}}"><img src="http://127.0.0.1/shopbanhanglaravel/public/uploads/contact/logo.png" alt="" /></a>
                        </div>
        ...
        <div class="header-bottom" id="navbar" style="margin-bottom: 15px"><!--header-bottom-->
            <div class="container">
                <div class="row">
                    <div class="col-sm-7">
                    ...
                    <div class="col-sm-5">
                        ...
                        <div class="search_box">
                            ...
                            <input type="text" style="width: 60%;margin-right: 5px;border: 1px solid orange; border-radius: 15px;background-color: #fff;color: #333 !important;font-size: 15px;font-weight: 400;" name="keywords_submit" id="keywords" placeholder="Tìm kiếm sản phẩm"/>
                            <div id="search_ajax"></div>

                           <input type="submit" style="margin-top:0;color:aliceblue;border-radius: 15px;font-weight: 600;font-size: 15px;" name="search_items" class="btn btn-primary btn-sm" value="Tìm kiếm">
    ...
    <footer id="footer"><!--Footer-->
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <p class="pull-left">Cao Minh - 19810310670   @EPU</p>
...
<script type="text/javascript">
    ...
    function viewed(){
         ...
         if(localStorage.getItem('viewed')!=null){
             ...
             document.getElementById('row_viewed').style.margin = '0';
...
<script type="text/javascript">
     ...
     function view(){
         ...
         if(localStorage.getItem('data')!=null){
             ...
             document.getElementById('row_wishlist').style.margin = '0';
             ...
             for(i=0;i<data.length;i++){
                ...
                $('#row_wishlist').append('<div class="row" style="margin:10px 0"><div class="col-md-4"><img width="100%" src="'+image+'"></div><div class="col-md-8 info_wishlist"><p>'+name+'</p><p style="color:#FE980F">'+price+'</p><a href="'+url+'">Đặt hàng</a><span style="padding-right:5px;padding-left:5px;color:red;margin-left:5px;border:1px solid red;cursor:pointer" onclick="removeProductFromLocalStorage(\'' + id + '\')">X</span></div>');
            }
   ...
   function add_wistlist(clicked_id){
        ...
        if(matches.length){
           ...
           $('#row_wishlist').append('<div class="row" style="margin:10px 0"><div class="col-md-4"><img width="100%" src="'+newItem.image+'"></div><div class="col-md-8 info_wishlist"><p>'+newItem.name+'</p><p style="color:#FE980F">'+newItem.price+'</p><a href="'+newItem.url+'">Đặt hàng</a><span style="padding-right:5px;padding-left:5px;color:red;margin-left:5px;border:1px solid red;cursor:pointer" onclick="removeProductFromLocalStorage(\'' + newItem.id + '\')">X</span></div>');
   ...
   function removeProductFromLocalStorage(productId) {
    if (localStorage.getItem('data') !== null) {
        ...
        if (index !== -1) {
            ...
            // Sau khi xóa, cập nhật lại view
            location.reload();
        } else {
            console.log('Không tìm thấy sản phẩm cần xóa trong Local Storage');
        }
    } else {
        console.log('Không có dữ liệu trong Local Storage');
    }
}
// function updateViewFromLocalStorage() {
//     var rowWishlist = document.getElementById('row_wishlist');
//     rowWishlist.innerHTML = ''; // Xóa nội dung hiện tại
            ...
            $('.add-to-cart').click(function(){
               ...
               // alert(id);
                ...
                if(parseInt(cart_product_qty)>parseInt(cart_product_quantity)){
                    alert('Số lượng trong kho không còn đủ vui lòng chọn lại số lượng ' );
                }else{
