...
<link rel="stylesheet" href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
<style>
    li.sub-menu.dcjq-parent-li .sub {
    ...
    <div id="sidebar" class="nav-collapse">
        ...
        <div class="leftside-navigation">
            ...
            <ul class="sidebar-menu" id="nav-accordion">
                ...
                @role('admin')
                <li class="sub-menu">
                    <a href="javascript:;" class="{{ (Request::segment(1)=='index-spatie') ? 'active' : '' }}">
                ...
                <li>
                    <a href="{{URL::to('/information')}}" class="{{ (Request::segment(1)=='information') ? 'active' : '' }}">
                        <i class="fa fa-dashboard"></i>
                        <span>Thông tin website</span>
                    </a>
                </li>
                 <li class="sub-menu">
                    <a href="javascript:;" class="{{ (Request::segment(1)=='insert-coupon' || Request::segment(1)=='list-coupon') ? 'active' : '' }}">
                        <i class="fa fa-book"></i>
                 ...
                 <li class="sub-menu">
                    <a href="javascript:;" class="{{ (Request::segment(1)=='delivery') ? 'active' : '' }}">
                        <i class="fa fa-book"></i>
                ...
                <li class="sub-menu">
                    <a href="javascript:;" class="{{ (Request::segment(1)=='add-category-product' || Request::segment(1)=='all-category-product') ? 'active' : '' }}">
                        <i class="fa fa-book"></i>
                 ...
                 <li class="sub-menu">
                    <a href="javascript:;" class="{{ (Request::segment(1)=='add-category-post' || Request::segment(1)=='all-category-post') ? 'active' : '' }}">
                        <i class="fa fa-book"></i>
                ...
                <li class="sub-menu">
                    <a href="javascript:;" class="{{ (Request::segment(1)=='add-brand-product' || Request::segment(1)=='all-brand-product') ? 'active' : '' }}">
                        <i class="fa fa-book"></i>
              ...
              {{--   <li>
                ...
                <li class="sub-menu">
                    <a href="javascript:;" class="{{ (Request::segment(1)=='add-slider' || Request::segment(1)=='manage-slider') ? 'active' : '' }}">
                        <i class="fa fa-book"></i>
                        <span>Slider</span>
                    </a>
                    <ul class="sub">
                 ...
                 <li class="sub-menu">
                    <a href="javascript:;" class="{{ (Request::segment(1)=='manage-order') ? 'active' : '' }}">
                        <i class="fa fa-book"></i>
                        <span>Đơn hàng</span>
                    </a>
                    <ul class="sub">
                ...
                <li class="sub-menu">
                    <a href="javascript:;" class="{{ (Request::segment(1)=='comment') ? 'active' : '' }}">
                        <i class="fa fa-book"></i>
                        <span>Bình luận</span>
                    </a>
                    <ul class="sub">
                ...
                <li class="sub-menu">
                    <a href="javascript:;" class="{{ (Request::segment(1)=='add-product' || Request::segment(1)=='all-product') ? 'active' : '' }}">
                        <i class="fa fa-book"></i>
                        <span>Sản phẩm</span>
                    </a>
                    <ul class="sub">
                 ...
                 <li class="sub-menu">
                    <a href="javascript:;" class="{{ (Request::segment(1)=='add-post' || Request::segment(1)=='all-post') ? 'active' : '' }}">
                        <i class="fa fa-book"></i>
                        <span>Bài viết</span>
                    </a>
                    <ul class="sub">
