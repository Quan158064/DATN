                             ...
                             <div class="product-image-wrapper">
                                ...
                                <div class="choose">
                                    <ul class="nav nav-pills nav-justified">
                                        ...
                                        <button class="button_wishlist" id="{{$product->product_id}}" onclick=""><span>Yêu thích</span></button>
                        
                                        </li>
                        
                                        <li ><a style="cursor: pointer;" onclick="" ><i class="fa fa-plus-square"></i>So sánh</a></li>
