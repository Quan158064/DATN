...
<div class="features_items"><!--features_items-->
                    ...
                    <div class="category-tab"><!--category-tab-->
                        <div class="col-sm-12">
                            <ul style="border-radius:5px " class="nav nav-tabs">
                                @php 
                                    $i = 0;
                                @endphp
                                ...
                                @foreach($cate_pro_tabs as $key => $cat_tab)
                                    ...
                                    $i++;
                                    @endphp
                                <li style="border-radius:20px " class="tabs_pro {{$i==1 ? 'active' : ''}}" data-id="{{$cat_tab->category_id}}"><a href="#tshirt" data-toggle="tab">{{$cat_tab->category_name}}</a></li>
