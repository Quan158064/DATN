						...
						<div class="tab-content">
							...
							<div class="tab-pane fade active in" id="reviews" >
								<div class="col-sm-12">
									...
									<form action="#">
										<span>
											<input style="width:100%;margin-left: 0;color:#000000;" type="text" class="comment_name" placeholder="Tên bình luận"/>
												
										</span>
										<textarea style="color:#000000;" name="comment" class="comment_content" placeholder="Nội dung bình luận"></textarea>
