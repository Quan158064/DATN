		...
		<div class="shopper-informations">
			...
			<div class="col-md-12 clearfix">
				<div class="bill-to">
				    ...
				    @endif
					<div class="col-md-6">	
					<p style="padding-top: 15px; color:red; font-size:16px;">VUI LÒNG CHỌN TỈNH THÀNH PHỐ ĐỂ TÍNH PHÍ VẬN CHUYỂN TRƯỚC KHI NHẬP ĐỊA CHỈ GIAO HÀNG(Đơn hàng sẽ tự động tính phí nếu bạn bỏ qua bước này)</p>
						<form>
							@csrf 
							...
							<input style="margin-bottom: 16px;" type="button" value="Tính phí vận chuyển" name="calculate_order" class="btn btn-primary btn-sm calculate_delivery">
