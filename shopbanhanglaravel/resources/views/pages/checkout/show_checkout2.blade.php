				...
				<div class="bill-to">
					...
					<div class="col-md-6 form-style">
						<form method="POST">
							...
							<textarea style="margin-bottom: 16px;" name="shipping_notes" class="shipping_notes form-control" placeholder="Ghi chú đơn hàng của bạn" rows="5"></textarea>
					...
					<!-- <div class="col-md-6">	
						...
						<p style="padding-top: 15px; color:rgb(5, 245, 61); font-size:16px;">Hãy nhập địa chỉ của bạn để tính phí vận chuyển nếu không đơn hàng của bạn sẽ tính phí vận chuyển mặc định</p>
					</div> -->
					...
					<form action="{{url('/update-cart')}}" method="POST">
						...
						<table class="table table-condensed">
								...
								<tr>
									...
									<td class="cart_quantity">
										<div class="cart_quantity_button">
											...
											<input disabled class="cart_quantity" type="number" min="1" name="cart_qty[{{$cart['session_id']}}]" value="{{$cart['product_qty']}}"  >
							...
							<tr><td>
								...
								<input style="font-weight: bold;padding: 8px;font-size: 16px;" type="button" value="Xác nhận đơn hàng" name="send_order" class="btn btn-primary btn-sm send_order">
							</td>
							<td>
								...
								<!-- <form action="{{url('/momo_payment')}}" method="post">
									...
									<button style="font-weight: bold;padding: 8px;font-size: 16px;" type="submit" class="btn btn-default check_out" name="payUrl" >Thanh toán MOMO</button>
								</form> -->
