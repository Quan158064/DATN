...
class PostController extends Controller
{
    ...
    public function save_post(Request $request){
        ...
        if($get_image){
            ...
            $name_image = current(explode('.',$get_name_image));//lấy cái tên đầu tiên trước . 

            $new_image =  $name_image.rand(0,99).'.'.$get_image->getClientOriginalExtension();//random 2 số bất kì tránh trùng tên 1 ảnh rồi thêm đường dẫn

            $get_image->move('public/uploads/post',$new_image);//đường dẫn tới nơi chứa ảnh đó
