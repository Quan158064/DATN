...
class CheckoutController extends Controller
{
  ...
  public function momo_payment(Request $request){
    ...
    $orderId = time() ."";
    $redirectUrl = "http://127.0.0.1/shopbanhanglaravel/checkout2";
    $ipnUrl = "http://127.0.0.1/shopbanhanglaravel/checkout2";
    $extraData = "";
...
$vnp_Returnurl = "http://localhost:8020/shopbanhanglaravel/checkout";
...
$returnData = array('code' => '00'
  ...
  public function onepay_payment(Request $request){
      ...
      $vpc_ReturnURL ="http://127.0.0.1:8020/shopbanhanglaravel/checkout";
      $vpc_Version ="2";
      $vpc_Command ="pay";
      $vpc_Locale ="vn";
      $vpc_Currency ="VND";
...
return view('pages.checkout.show_checkout2')->with('category',$cate_product)->with('brand',$brand_product)->with('meta_desc',$meta_desc)->with('meta_keywords',$meta_keywords)->with('meta_title',$meta_title)->with('url_canonical',$url_canonical)->with('city',$city)->with('slider',$slider)->with('category_post',$category_post);
}
